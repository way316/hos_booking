...
import com.atguigu.yygh.cmn.hosp.mapper.ScheduleMapper;
import com.atguigu.yygh.cmn.hosp.repository.ScheduleRepository;
...
import com.atguigu.yygh.cmn.model.hosp.BookingRule;
...
import com.atguigu.yygh.cmn.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper, Schedule> implements ScheduleService {
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        for(int i=0,len=dateList.size();i<len;i++) {
            ...
            //最后一页最后一条记录为即将 预约   状态 0：正常1：即将放号 -1：当天已停止挂号
